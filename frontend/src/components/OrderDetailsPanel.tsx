...
import type { CustomerGender, OrderType } from '@/api/client'
        ...
        {isOpen ? (
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-200/80 bg-slate-50 px-3 py-2 text-xs text-slate-600">
            <div className="flex items-center gap-1.5 text-xs font-medium text-slate-500">
              <Icon name="calendar" className="text-sm text-slate-400" />
              <span>{formatDateTime(new Date().toISOString())}</span>
            </div>
            <div className="flex items-center gap-1 text-xs font-medium text-slate-500">
              <Icon name="clock" className="text-sm text-slate-400" />
              <span>
